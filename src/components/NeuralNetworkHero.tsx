...
export default function NeuralNetworkHero({
  title,
  description,
  badgeText = "AI-Powered Business Automation",
  badgeLabel = "New",
  ctaButtons = [
    { text: "Book My Free Strategy Call", href: "#contact", primary: true },
  ],
  microDetails = ["Done-For-You Systems", "Predictable Revenue", "No-Code Required"]
